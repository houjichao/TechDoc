...
![img](https://img-blog.csdnimg.cn/img_convert/2aaf7695719412bdb251f251f7f320c6.png)
...
![img](https://img-blog.csdnimg.cn/img_convert/b693dd50b0049dab9e7d9be9b2563749.png)

如果t是普通表，T1时刻的间隙和加锁状态如下：

![img](https://img-blog.csdnimg.cn/img_convert/12c42e75ba35da458bcc4e801ccb379d.png)

从上面的实验效果可以看出，session B 的第一个 insert 语句是可以执行成功的。这是因为，对于引擎来说，p_2018 和 p_2019 是两个不同的表，也就是说 2017-4-1 的下一个记录并不是 2018-4-1，而是 p_2018 分区的 supremum。

实际的锁状态：

![img](https://img-blog.csdnimg.cn/img_convert/8ab8a9c6fddb47478a6a6eccd4cfe667.png)

MyISAM 分区表的例子：

![img](https://img-blog.csdnimg.cn/img_convert/47e417d5ae1093725479a2c88374062f.png)
...
下图7所示就是我创建的一个包含了很多分区的表 t_myisam，执行一条插入语句后报错的情况。

![img](https://img-blog.csdnimg.cn/img_convert/91d4e9a26eeec76ce7ead84fc6746b31.png)
...
![img](https://img-blog.csdnimg.cn/img_convert/0c13444e0c6b1cd70d4aaf64d2f13eef.png)

![img](https://img-blog.csdnimg.cn/img_convert/a6fd96ed12d6f411b4e36006d823f65a.png)
...
MySQL 还支持 hash 分区、list 分区等分区方法。你可以在需要用到的时候，再翻翻[手册](https://dev.mysql.com/doc/refman/8.0/en/partitioning-types.html)。

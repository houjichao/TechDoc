...
其实，你应该非常熟悉这个 trx_id。它就是在我们在[第 8 篇文章](https://blog.csdn.net/weixin_40629244/article/details/109429079)中讲事务可见性时，用到的事务 id（transaction id）。
...
![img](https://img-blog.csdnimg.cn/img_convert/2fbe31f415a0228b0dde97b4d367032f.png)
...
其实，这个数字是每次查询的时候由系统临时计算出来的。它的算法是：把当前事务的 trx 变量的指针地址转成整数，再加上 2^48。
...
![img](https://img-blog.csdnimg.cn/img_convert/eb122ebff50132368d993df5fd4e56e2.png)

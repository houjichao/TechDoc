...
![img](https://pic4.zhimg.com/80/v2-00b32a826656f607086e28526cc63003_1440w.webp)

留意图中的：GWToolkit @ 13ef233
...
- 虽然 Git 提供的子模块功能已足够方便好用，但仍请在为主仓库项目添加子模块之前确保这是非常必要的。毕竟有很多编程语言（如 [Go](https://link.zhihu.com/?target=https%3A//golang.org/)）或其他依赖管理工具（如 Ruby’s [rubygems](https://link.zhihu.com/?target=http%3A//guides.rubygems.org/), Node.js’ [npm](https://link.zhihu.com/?target=https%3A//docs.npmjs.com/getting-started/what-is-npm), or Cocoa’s [CocoaPods](https://link.zhihu.com/?target=https%3A//cocoapods.org/about) and [Carthage](https://link.zhihu.com/?target=https%3A//github.com/Carthage/Carthage)）可以更好的 handle 类似的功能
